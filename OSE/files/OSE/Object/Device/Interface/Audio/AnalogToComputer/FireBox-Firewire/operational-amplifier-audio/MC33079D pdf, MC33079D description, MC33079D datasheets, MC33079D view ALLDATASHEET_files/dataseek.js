...
else if(strPath=="alldatasheetcn.com" || strPath=="www.alldatasheetcn.com" || strPath=="pdf1.alldatasheetcn.com" || strPath=="components.alldatasheetcn.com") strLang = "alldatasheetcn.com";
...
if(tmpChk==1) theForm.action = "//www."+strLang+"/view.jsp?Searchword=" + theForm.sSearchword.value.toUpperCase(); 
else if(tmpChk==5) theForm.action = "//www."+strLang+"/view_datasheet.jsp?Searchword=" + theForm.sSearchword.value.toUpperCase();  
else if(tmpChk==3) theForm.action = "//www."+strLang+"/view_marking.jsp?Searchword=" + theForm.sSearchword.value.toUpperCase();  
else if(tmpChk==4) theForm.action = "//www."+strLang+"/view_package.jsp?Searchword=" + theForm.sSearchword.value.toUpperCase();  
else theForm.action = ((bSplit)?"//category."+strLang:"/category")+"/index.jsp?sSearchword=" + theForm.sSearchword.value.toUpperCase();
